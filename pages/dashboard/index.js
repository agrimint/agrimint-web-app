  ...
  const transactions = [
    {
      icon: `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path stroke="currentColor" d="M5 15L15 5M15 5H8.33333M15 5V11.6667" stroke-width="1.68595" stroke-linecap="round" stroke-linejoin="round" />
        </svg>`,
      counterparty: "Tunde",
    ...
    {
      icon: `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path stroke="currentColor" d="M5 5L15 15M15 15V8.33333M15 15H8.33333" stroke-width="1.68595" stroke-linecap="round" stroke-linejoin="round" />
        </svg>`,
      counterparty: "Obi",
      ...
      <div className="w-full bg-teal-600">
        <div className="px-4 py-8">
          ...
          <div className="mb-4 flex flex-col rounded-lg bg-teal-50">
            ...
            <Link key={i} href={account.url} className={`flex ${(i < accounts.length - 1) && `border-b`} p-4`}>
              <Image src={`data:image/svg+xml;utf8,${account.icon}`} className="my-auto stroke-gray-900" width={16} height={16} alt="Icon" />
        ...
        <div className="rounded-tl-xl rounded-tr-xl bg-white">
          <h2 className="w-full border-b border-gray-100 p-4 text-center text-sm font-bold uppercase text-gray-400">Latest transactions</h2>          
          <div className="flex flex-col pb-32">
            {transactions?.map((transaction, i) => (
              <div key={i} className="flex w-full border-b border-gray-100 px-6 py-3">
                <Image src={`data:image/svg+xml;utf8,${transaction.icon}`} className="my-auto stroke-gray-900" width={20} height={20} alt="Icon" />                
